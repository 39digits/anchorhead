# Description: Install Alacritty terminal emulator with Nord theme
...
# Configure Alacritty with custom settings
mkdir -p ~/.config/alacritty
cp "$PROJECT_ROOT"/configs/alacritty/alacritty.toml ~/.config/alacritty/alacritty.toml
# cp "$PROJECT_ROOT"/themes/nord/alacritty.toml ~/.config/alacritty/theme.toml
