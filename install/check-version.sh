# Description: This script checks the OS version and architecture before proceeding with the installation of a software package.
# It ensures that the script is only run on Ubuntu 24.04 or higher and on x86 architectures (x86_64 or i686).
